	...
	<div class="<?php echo $class ?>" itemprop="blogPost" itemscope="itemscope" itemtype="http://schema.org/BlogPosting">
		<div class="main">
			...
			<div class="date">
				...
				<?php 
					if (disqus_count()) {?> - <span><nobr><a href="<?php echo $p->url?>#disqus_thread">Comments</a></nobr></span>
				<?php } elseif (facebook()){ ?> - 
					<nobr><a href="<?php echo $p->url ?>#comments"><span><fb:comments-count href=<?php echo $p->url ?>></fb:comments-count> Comments</span></a></nobr>
				<?php } ?>
			</div>
