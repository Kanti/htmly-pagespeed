...
.share a.twitter { background: url(<?php echo site_url() ?>themes/pagespeed/img/share-twitter.png) left top no-repeat; }
.share a.facebook { background: url(<?php echo site_url() ?>themes/pagespeed/img/share-facebook.png) left top no-repeat; }
.share a.googleplus { background: url(<?php echo site_url() ?>themes/pagespeed/img/share-googleplus.png) left top no-repeat; }
